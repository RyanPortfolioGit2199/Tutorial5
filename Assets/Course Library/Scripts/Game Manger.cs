...
public class GameManger : MonoBehaviour
{
    ...
    {
        while (true)/// A While Loop is a fusion of a For Loop and an If Statement, A While Loop will continually the code but instead of giving it a defined number of times(Like a For Loop). It uses a condition(True/False) to stop running (Like an If Statement)
        {
